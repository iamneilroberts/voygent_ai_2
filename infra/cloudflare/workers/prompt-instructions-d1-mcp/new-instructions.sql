...
'Core startup instructions with confidence-based dynamic loading', 'core', '1.0.0', 1),
...
```',
'Universal 3-tier image capture strategy for all travel websites', 'technical', '1.0.0', 1),
...
'Verify all daily activities exist and are available', 'verification', '1.0.0', 1),
...
```',
'Complete trip verification with commission analysis', 'verification', '1.0.0', 1),
...
'Commission structure, targets, and optimization strategies', 'revenue', '1.0.0', 1);