...
const localStorageAtoms = {
  ...
  // Voygent status bar
  voygentStatusVerbosity: atomWithLocalStorage<'minimal'|'normal'|'verbose'>('voygentStatusVerbosity','normal'),
  voygentDefaultQuery: atomWithLocalStorage<string>('voygentDefaultQuery',''),
  voygentShowWelcome: atomWithLocalStorage<boolean>('voygentShowWelcome', true),
  // Last observed token usage (approx) for status pill fallback
  voygentLastUsage: atom<{
    ...
    price?: number;
    approximate?: boolean;
  } | null>({ key: 'voygentLastUsage', default: null }),
};
